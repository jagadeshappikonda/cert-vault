...
```
Method : GET 
Endpoint : /api/user/certificates 
...
```
Method : Post 
Endpoint : /api/user/certificates/add 
Query params : NA
Payload : 
    {
      "certificateId": "M0953",
...
Response Json : {"responseCode": "message"}
...
```
Method : Put 
Endpoint : /api/user/certificates/edit 
Query params : ?certificateId = P1001
Payload : 
    {
...
```
Method : Delete 
Endpoint : /api/user/certificates/delete 
Query params : ?certificateId = 2
Payload : Empty
Response Json : {"responseCode": "message"}
Response Code : 204(No Content)/200(OK)/400(Bad Request)/401(Unauthorized)/500(Internal Server Error)
```
...
```
Method : GET 
Endpoint : /api/user/certificates/search
Query params : ?certificateId = M0953
Payload : Empty
Response Json :{
      "certificateId": "M0953",
      "name": "Machine Learning Engineer Certificate",
